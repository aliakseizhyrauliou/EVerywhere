        ...
        var bePaidConfiguration = new BePaidConfiguration
        {
            ...
            CheckoutAuthorization = new Checkout
            {
                ...
                Settings = new Settings
                {
                    ...
                    Language = "RU",
                    NotificationUrl =
                        "https://5bfc-134-17-4-170.ngrok-free.app/api/BePaid/verifyHoldNotification",
            ...
            CheckoutPayment = new Checkout
            {
                ...
                Settings = new Settings
                {
                    ...
                    Language = "RU",
                    NotificationUrl =
                        "https://5bfc-134-17-4-170.ngrok-free.app/api/BePaid/verifyPaymentNotification",
                    SaveCardToggle = new SaveCardToggle
                    {
                        Display = true,
                        CustomerContract = true
            ...
            CheckoutCreatePaymentMethod = new Checkout
            {
                ...
                Settings = new Settings
                {
                    ...
                    Language = "RU",
                    NotificationUrl =
                        "https://5bfc-134-17-4-170.ngrok-free.app/api/BePaid/verifyPaymentMethodNotification",
                    SaveCardToggle = new SaveCardToggle
                    {
                        Display = true,
                        CustomerContract = true
